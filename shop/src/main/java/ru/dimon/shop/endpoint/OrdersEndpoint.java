package ru.dimon.shop.endpoint;
...
import ru.dimon.shop.services.OrdersService;
import ru.dimon.shop.ws.orders.GetOrdersRequest;
import ru.dimon.shop.ws.orders.GetOrdersResponse;
import ru.dimon.shop.ws.orders.OrderWS;
...
public class OrdersEndpoint {
    ...
    private OrderWS createOrderWS(OrderDto dto) {
        ...
        ws.setStatus(ru.dimon.shop.ws.orders.OrderStatus.fromValue(dto.getStatus().toString()));
